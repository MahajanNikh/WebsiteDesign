          ...
          packages.map((pkg, index) =>
            <div key={index} className="border py-10 md:px-6 px-4 rounded-lg shadow-3xl">
              ...
              <ul className="mt-4 space-y-2 px-4">
                <li className="flex gap-3 items-center"><img src={pkg.green} className="w-4 h-4" />Videos of Lessons</li>
                ...
                <li className="flex gap-3 items-center"><img src={pkg.green} className="w-4 h-4" />Monthly conferences</li>
                <li className="flex gap-3 items-center"><img src={pkg.green} className="w-4 h-4" />Personal advice from teachers</li>
              </ul>
              <div className="w-full mx-auto mt-8 flex items-center justify-center">
                <button className="btnPrimary rounded-md">Get started</button>
              </div>
            </div>)
        }
      </motion.div>
